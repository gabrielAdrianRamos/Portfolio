...
Command: npx gltfjsx@6.5.0 public/astronaut.glb 
...
export function Astronaut(props) {
  ...
  const adjustRocket = () => {
    ...
    if (window.innerWidth < 768) {
      screenPosition = [0.5, -2, 2];
      screenScale = 0.02;
    } else {
      screenPosition = [7.5, -1, 2];
      screenScale = 0.03;
    }
    return [screenPosition, screenScale];
  };

  const [rocketPosition, rocketScale] = adjustRocket();
